...
public class CalculatorTest {
    ...
    public void powTwoPositiveNumbers() {
        double resultMul = mCalculator.pow(5d, 2d);
        assertThat(resultMul, is(equalTo(25d)));
    }
    @Test
    public void powFirstNegativeNumbers() {
        double resultMul = mCalculator.pow(-5d, 3d);
        assertThat(resultMul, is(equalTo(-125d)));
    }

    @Test
    public void powSecondNegativeNumbers() {
        double resultMul = mCalculator.pow(10d, -3d);
        assertThat(resultMul, is(equalTo(0.001d)));
    }

    @Test
    public void powZeroPositiveNumbers() {
        double resultMul = mCalculator.pow(0d, 3d);
        assertThat(resultMul, is(equalTo(0d)));
    }

    @Test
    public void powSecondZeroeNumbers() {
        double resultMul = mCalculator.pow(0d, -1d);
        assertThat(resultMul, is(equalTo(Double.POSITIVE_INFINITY)));
    }


    @Test
    public void powNegativeZeroNumbers() {
        double resultMul = mCalculator.pow(-0d, -1d);
        assertThat(resultMul, is(equalTo(Double.NEGATIVE_INFINITY)));
    }
}